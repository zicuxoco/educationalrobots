...
public class SinWave {
	public final static int ACTUAL_SIZE = 50;
	public final static int TRAINING_SIZE = 10;
	public final static int INPUT_SIZE = 2;
	public final static int OUTPUT_SIZE = 1;
	public final static int NEURONS_HIDDEN_1 = 2;
	public final static int NEURONS_HIDDEN_2 = 0;
	public final static boolean USE_BACKPROP = false;
