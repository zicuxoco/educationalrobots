...
public class XOR {
	...
	public static void main(final String args[]) {
		...
		neural.matrix.Matrix mat1 = network.getOutputLayer().getMatrix();
		
		System.out.print("" + mat1.size());
		
		for(int jj=0;jj<= mat1.getRows();jj++){
			for(int ii=0;ii<= mat1.getCols();ii++){
				System.out.print("" + mat1.get(jj, ii));
			}		
		}
	}
}
