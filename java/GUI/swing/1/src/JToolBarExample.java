...
//        setFloatable(false)  to make the toolbar non movable
    ...
    public void addButtons(JToolBar jtbToolBar) {
        ...
        //first button
        jbnToolbarButtons = new JButton(new ImageIcon("./res/left.gif"));
        ...
        //2nd button
        jbnToolbarButtons = new JButton(new ImageIcon("./res/right.gif"));
        ...
        //3rd button
        jbnToolbarButtons = new JButton(new ImageIcon("./res/open.gif"));
        ...
        //4th button
        jbnToolbarButtons = new JButton(new ImageIcon("./res/save.gif"));
    ...
    public static void main(String[] args) {
    	JToolBarExample jtfToolbar = new JToolBarExample();		//Note it extends Frame.
        jtfToolbar.pack();
