...
public class JMenuExample implements ActionListener, ItemListener{
...
//        Accelerators, offer keyboard shortcuts to bypass navigating the menu hierarchy.
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = JMenuExample.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createGUI() {
        ...
        JMenuExample app = new JMenuExample();
