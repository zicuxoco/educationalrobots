...
public class PGRFlyCapture {
    ...
    //
    public static interface FlyCaptureCallback extends Callback {
    ...
    public static int /* FlyCaptureError */ flycaptureBusEnumerateCamerasEx(FlyCaptureInfoEx[] arInfo,
            IntByReference puiSize) {
        return flycaptureBusEnumerateCamerasEx(arInfo[0], puiSize);
    }
...
//            NativeLong ulNumEvents, FlyCaptureImageEvent[] arpEvents) {
//        return flycaptureInitializeNotify(context, ulNumEvents, arpEvents[0]);
//    }
...
//            FlyCaptureImage pimage, FlyCaptureImageEvent arpEvents[]) {
//        return flycaptureLockNextEvent(context, pimage, arpEvents[0]);
//    }
...
//            FlyCaptureImageEvent arpEvents[]) {
//        return flycaptureUnlockEvent(context, arpEvents[0]);
//    }
